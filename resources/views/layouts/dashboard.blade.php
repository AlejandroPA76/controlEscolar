            ...
            <div class="list-group list-group-flush">
                ...
                @can('tutores_index')
                    <a href="{{ route('admin.indexTutores') }}"
                        class="list-group-item list-group-item-action bg-light">Tutores</a>
                @endcan
                ...
                @can('permission_index')
                    <a href="{{ route('permissions.index') }}"
                        class="list-group-item list-group-item-action bg-light">Permisos a usuarios</a>
                @endcan

                @can('role_index')
                    <a href="{{ route('roles.index') }}" class="list-group-item list-group-item-action bg-light">Roles de
                        usuario</a>
                @endcan
