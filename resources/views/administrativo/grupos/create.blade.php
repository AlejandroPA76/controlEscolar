                        ...
                        <form action="{{ route('grupos.store') }}" method="POST" autocomplete="off">
                            ...
                            <div>
                                ...
                                <div class="form-row">
                                    ...
                                    <input class="form-control" type="number" min="0" max="30" name="cupo" value=""
                                        required>
                                </div>
                                    ...
                                    <select class="form-control" name="docente" required>
                                        ...
                                        @foreach ($docenteslist as $docente)
                                            <option value="{{ $docente->id }}">{{ $docente->nombre }}
                                                {{ $docente->apellido_p }} {{ $docente->apellido_m }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <button type="submit" id="sendlogin" class="btn btn-primary float-right">Crear
                                        grupo</button>
